...
Rules.propTypes = {
  list: PropTypes.shape({
    allowedashita: PropTypes.arrayOf(PropTypes.string),
    disallowedashita: PropTypes.arrayOf(PropTypes.string),
    discordwindower: PropTypes.arrayOf(PropTypes.string),
    disallowedwindower: PropTypes.arrayOf(PropTypes.string),
