...
//removed discord, allowed, disallowed for formatting + directly inputted some to this page instead of config

const Rules = ({ list }) => {
  const { terms, rules, yells } = list;
        ...
        <Col>
          <InfoDisplay title="Rule Violation Punishments">
            <Card.Text>
              ...
              <li>
                {' '}
                Navmesh Abuse = Move them off the wall > Repeated Abuse (3
                times) = Warning > 2 Week Suspension > 1 Month Suspension
              </li>
              <li>
                {' '}
              ...
              <li>
                ...
                Suspension > Banned (This includes EXP mobs, mobs that others
                are farming and NMs. TBD by the GM handling the ticket)
              </li>
              <li>
                {' '}
            ...
            <Card.Text>
              ...
              <table>
                <tr>
                  ...
                  <td>
                    <center>
                      <strong>Allowed/Disallowed Windower Plugin</strong>
                    </center>
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    Petinfo Recast RollTracker Scoreboard Sexchange Shorthand
                    (Never for claiming) Singlerace Skillchain Status
                  ...
                  <td>
                    ...
                    EnemyBar Enternity FindAll FishingCrashFix GameTime Gearswap
                    (Not to be used for actions based on what a mob does etc)
                    Highlight IME InfoBar InfoReplacer InstaLS LatentChecker
                    Linker Logger OhShi MacroChanger Nostrum PetTP Plugin
                    Manager Pouches Respond Rhombus RollTracker Scoreboard
                    SetBGM Shortcuts (Never for claiming) Skillchain
                    SpeedChecker SpellCheck SSOrganiser Stopwatch Text Tickle
                    Timers Timestamp TParty Translate TreasurePool Update
                    Weathermon WinControl XIVBar ZoneTimer<p></p>
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    Lootwhore Lotomatic Mapdot Minimap Multisend No-ckback Nomad
                    Onevent Paranormal Peekaboo Repeat Repeater Servo
                    Skeletonkey Synplicity Watchdog Zoom
                    <p></p>
                    *Notes Fillmode - Allowed unless you use it for pulling
                    things through the floor/wall you couldn't normally target
                    etc.
                    <p></p>
                    <p></p>
                  </td>
                  <td>
                    ...
                    <p></p>
                    <p> </p> <p> </p> <p> </p> <p> </p>
                    *Note Wireframe - Allowed unless you use it for pulling
                    things through the floor/wall you couldn't normally target
                    etc.
                  </td>
                </tr>
      ...
      <Row className="my-3">
        <Col>
          <InfoDisplay title="Discord Rules">
            <p></p>
            <p>
              1) Please be respectful to each other. Consider this phrase when
              typing, treat others as you would want to be treated. You wouldn't
              want someone yelling at you or belittling you so you don't need to
              do it to another person.
            </p>
            <p></p>
            <p>
              2) Please keep the cursing at a minimum. Some people prefer not to
              read constant cursing. We know sometimes a word or two will slip
              out in the heat of the moment and that is ok but if it becomes a
              habit we will go to you in private about it.
            </p>
            <p></p>
            <p>3) Do not post nudity of any kind.</p>
            <p></p>
            <p>
              4) Do not give out any personal information in public. If you must
              send it do so via a PM. There are too many people that will take
              advantage of this personal information.
            </p>
            <p></p>
            <p>
              5) Most importantly we want you all to have fun while you use our
              discord. We know you won't agree with everything we implement and
              that is ok. We do ask that you follow our rules. If you feel you
              won't be able to then we kindly thank you for using our discord
              and ask you to move on to somewhere else to chat.
            </p>
            <p></p>
            ...
            <p></p>
            <li>
              It is at the moderators discretion if a player has crossed the
              line. If a Staff or Moderator asks a player to do something, that
              player needs to follow the request. If they feel this request is
              not appropriate, contact Shoruto with a screenshot of the request.
            </li>
            <p></p>
            <li>
              If a player feels a Staff is talking inappropriately to another
              player, contact Shoruto or Juul with a screenshot of the
              inappropriate chat.
            </li>
            <p></p>
            <li>
              To make our Discord the best possible it takes a community effort.
              Our moderators won't be able to see everything so if a player
              happens to see someone breaking one of our rules or has crossed
              the line somewhere else, please let a moderator know in a private
              message with a screenshot of the chat that you feel broke the
              rule.
            </li>
            <p></p>
            <p>Moderators:</p>
            <p>
                   Aiko (Also the head GM so please contact one of the other
              moderators first)
            </p>
            <p>     Juul</p>
            <p>     Shoruto</p>
      ...
      <Row className="my-3">
        <Col>
          <InfoDisplay title="Punishment List">
            ...
            <li>
              {' '}
              MPK = 2 Week Suspension > 1 Month Suspension > 3 Month Suspension
              > Banned (If it falls under the lines of harassment due to the
              dialogue exchanged between players follow Harassment punishment
              lines)
            </li>
            <li> RMT = Banned (Seller and Buyer)</li>
            <li>
              {' '}
              Too many characters online = Warning > 2 Week Suspension > 2 Month
              Suspension > Banned
            </li>
            <li>
              {' '}
            ...
            <li>
              {' '}
              Exploits that are similar to Duping or reselling exploits = Banned
            </li>
            <li>
              {' '}
              Character Names that break the rule = Warning with forced name
