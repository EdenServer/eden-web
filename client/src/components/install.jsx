      ...
      <Row className="mb-3">
        <Col>
          <InfoDisplay title="Account Registration">
            <Card.Text>
              The bootloader (black login screen) supports registering an account. If you are prompted for a registration code, one can be obtained from
              players who have accumulated 120 hours (5 days) of playtime and who's current job is level 15 or greater. Make sure you have Eden completely installed
