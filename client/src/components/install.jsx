      ...
      <Row className="mb-3">
        <Col>
          <InfoDisplay title="Account Registration">
            <Card.Text>
              Please read the <Link to="/tools?user=register">rules</Link>. to
        ...
        <Col>
          <InfoDisplay title="Helpful Install/Setup Links">
            ...
            <Card.Text>
              ...
              <p>
                <a
                  href="https://bit.ly/34Xr227"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  Eden Installer - https://bit.ly/34Xr227
                </a>
              </p>
              <p>
                <a
                  href="https://bit.ly/355DqNs"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  {' '}
              ...
              <p>
                <a
                  href="https://bit.ly/32QMSU4 "
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  Login Problems - https://bit.ly/32QMSU4
                </a>
              </p>
              <p>
                <a
                  href="https://bit.ly/3co3d6U "
                  rel="noopener noreferrer"
                  target="_blank"
                >
              ...
              <p>
                <a
                  ...
                  target="_blank"
                >
                  In-game Issues - https://bit.ly/2Iaezh5
                </a>
              </p>
              <p>
                <a
                  href="https://bit.ly/2TAT1j3 "
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  Quest/Mission Issues - https://bit.ly/2TAT1j3
                </a>
              </p>
              <p>
          ...
          <InfoDisplay title="Returning / Migrating from another private server">
            ...
            <ul>
              <li>
                ...
                suggest to use Ashita for a more stable experience.
              </li>
