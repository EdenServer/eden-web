    ...
    return (
        <Menu className="gm_menu" vertical>
            ...
            <Menu.Item className="gm_menu-credits">
                <div style={{ fontSize: '10px' }}>All FINAL FANTASY® XI content and images © 2002-2020 SQUARE ENIX CO., LTD. All Rights Reserved.</div>
                <br/>
                <div style={{ fontSize: '10px' }}>FINAL FANTASY® is a registered trademark of SQUARE ENIX CO., LTD. All Rights Reserved.</div>
            </Menu.Item>
        </Menu>
    );
};
