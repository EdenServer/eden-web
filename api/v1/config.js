module.exports = {
    ...
    links: [
        ...
        },
        {
            ...
            header: 'Eden Wiki',
            description: 'This is a player led wiki open for everyone to edit. Although it is specific to Eden, it may have incorrect information due to the fact that it is not an official source of information.',
        },
        {
        ...
        },
        {
            ...
            header: 'FFXIclopedia',
            description: 'The defacto go-to resource of this era. Keep in mind that this site has been updated post-era and you may need to browse history of the page to get more accurate data.',
        },
        {
        ...
        },
        {
            ...
            header: 'FFXIDB',
            description: 'Common site to track drop rates of items. Keep in mind that drop rates stay updated when people use their plugin. With things like TH10 on current retail this data may be inaccurate.',
        },
        {
            url: 'http://ashita.atom0s.com/',
            image: 'https://www.ashitaxi.com/assets/img/ashita.ico',
            header: 'Ashita',
            description: 'Eden officially supports Ashita v3 to enhance gameplay. Ashita v3 comes bundled with the Eden installer. You can find support for Ashita v3-specific things here.',
        },
        {
            url: 'http://windower.net/',
            image: 'http://windower.net/img/icon.png',
            header: 'Windower',
            description: 'Windower 4 and 5 are not officially supported on Eden to enhance gameplay. While we do not offer setup or troubleshooting assistance, it does work on Eden.',
        }
    ],
    install: {
        source1: '',
