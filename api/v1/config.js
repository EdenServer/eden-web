module.exports = {
  rules: {
    ...
    search: {
      updated: '12/14/2020',
      list: ['Do not use profanity, hate messages or any harassing statements. These are public-facing channels.'],
    },
    discord: {
      updated: '5/22/2020',
      list: [
  ...
  links: [
    ...
    },
    {
      ...
      header: 'Eden Wiki',
      description: "This is a player-led wiki open for everyone to edit, intended to be specific to Eden's era.",
    },
    {
    ...
    },
    {
      ...
      header: 'FFXIclopedia',
      description: "The OG resource of era. You'll want to backdate any page you visit to get era-accurate data.",
    },
    {
      url: 'https://www.bg-wiki.com/',
      image: 'https://static.ffxiah.com/images/icon/15076.png',
      header: 'BG Wikipedia',
      description: "Another resource, heavily updated for the modern era. Can be a good place to get information that isn't provided by other sources.",
    },
    {
    ...
    },
    {
      ...
      header: 'JP Wiki',
      description: "This wiki offers another resource for data from the retail and 2008 eras. You'll need some form of translation if you can't read Japanese.",
    },
    {
    ...
    },
    {
      ...
      header: 'FFXIDB',
      description: 'Common site to track drop rates of items. With things like drop rate changes and TH10 on retail, this data may not always be accurate.',
    },
    {
